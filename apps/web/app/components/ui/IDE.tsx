...
export default function IDE({ code, setCode, onRun, isRunning = false, completed = false }: IDEProps) {
    return (
                ...
                {isRunning && (
                    <div className="absolute inset-0 bg-gray-900 bg-opacity-10 flex items-center justify-center">
                        <div className="bg-white rounded-lg shadow-lg p-4 flex items-center">
                            ...
                            <span className="text-gray-700 font-medium">Executing code in ROS2 container...</span>
                        </div>
                    </div>
                )}
            </div>

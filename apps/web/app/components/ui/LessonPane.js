...
export default function LessonPane({ exercise }) {
    return (
        <div className="w-full h-full bg-white text-black shadow-xl border-r border-gray-200 overflow-auto">
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-4 border-b">
                <div className="flex items-center justify-between">
                    <Link
                        href="/"
                        className="flex items-center text-gray-300 hover:text-orange-400 transition-colors duration-200 font-medium"
                    >
            ...
            <div className="p-6">
                <div className="mb-8">
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-4 rounded-lg mb-4 border-l-4 border-orange-500">
                        <p className="text-gray-800">
                            <span className="font-bold text-orange-600 uppercase tracking-wide text-sm">
                                Objective:
                            </span>
                            <span className="ml-2">
                ...
                <div className="mb-8">
                    <h3 className="text-lg font-bold mb-4 text-gray-900 flex items-center">
                        <span className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-3 py-1 rounded-full text-sm uppercase tracking-wide">
                            Instructions
                        </span>
                    </h3>
